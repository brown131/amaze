...
* [`src/cljs/amaze/`](src/cljs/amaze/): SPA source files (ClojureScript,
[re-frame](https://github.com/Day8/re-frame))
  - [`core.cljs`](src/cljs/amaze/core.cljs): contains the SPA entry point, `init`
...
7. Clone this repo and open a terminal in the `amaze` project root directory
...
The `debug?` variable in [`config.cljs`](src/cljs/amaze/config.cljs) defaults to `true` in
...
```clj
(ns amaze.example
  (:require [amaze.config :as config])
